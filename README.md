...
![GLPI](https://img.shields.io/badge/GLPI-F5A623?style=flat-square&logo=glpi&logoColor=white)
...
|---|---|---|
| **Meu Garagem App** | App de gestão de veículos, do protótipo de UI/UX até a implementação, com pipeline de agentes de IA (PRD → TDD → código → review) | React Native, Reanimated, Claude Code |
| **Presença** | Sistema de monitoramento por vídeo com reconhecimento facial para controle de acesso | Python, Visão Computacional |
| **Automações internas** | Rotinas de provisionamento, inventário e relatórios que reduziram trabalho manual no suporte | PowerShell, Python, n8n, Power BI |
